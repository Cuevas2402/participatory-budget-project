    ...
    <div class="card h-100">
        ...
        <div class="card-body" style="padding: 0;">
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                    <p class="process-content-card"><strong>Status: </strong><p class = "<?php if($row['estatus'] == 'Aceptado'){echo " text-success ";} if($row['estatus']== 'Pendiente'){echo " text-primary ";} if($row['estatus']== 'Rechazado'){echo " text-danger ";} ?>"><?php echo $row['estatus']; ?></p></p>
                </li>
