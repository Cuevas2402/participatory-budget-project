<html>
    ...
    <div class="container mt-5">
        <center><h5>Modificar participación de usuario #<?php echo $usuario;?></h5></center>
        <br>
        <form action="edit.php">
            <input type="hidden" name="process_id" id="edit-process-id" value="<?=$proceso;?>">
            <input type="hidden" name="user_id" id="edit-user-id" value="<?=$usuario;?>">

            <label for="title" class="form-label mb-0">Nuevo título</label>
            <input type="text" class="form-control mb-4" name="title"> 

            <label for="proposal" class="form-label mb-0">Nueva propuesta</label>
            ...
            <center>
                ...
                <form action="../participaciones.php">
